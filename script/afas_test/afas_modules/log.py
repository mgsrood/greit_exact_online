from afas_modules.config import save_laatste_sync, save_reporting_year
...
def sync_log(klantnaam, nieuwe_laatste_sync, errors_occurred, connection_string, finn_it_connection_string, script_id, script):
    # Succes en start log
...
def end_log(start_time, finn_it_connection_string, script, script_id):
