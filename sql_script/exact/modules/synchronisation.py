...
class SyncFormatManager:
    ...
    def get_endpoints(self):
        ...
        endpoints = {
            "Budget": f"budget/Budgets?$filter=Modified ge datetime'{start_date}'&$select=ID,AmountDC,BudgetScenarioDescription,CostcenterDescription,CostunitDescription,Division,GLAccount,ItemDescription,ReportingPeriod,ReportingYear",
