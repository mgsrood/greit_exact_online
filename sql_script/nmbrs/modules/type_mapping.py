    ...
    def __post_init__(self):
        self.mappings = {
            ...
            "FTE": {
                ...
                'Uren_Maandag_Week1': 'decimal',
                'Uren_Dinsdag_Week1': 'decimal',
                'Uren_Woensdag_Week1': 'decimal',
                'Uren_Donderdag_Week1': 'decimal',
                'Uren_Vrijdag_Week1': 'decimal',
                'Uren_Zaterdag_Week1': 'decimal',
                'Uren_Zondag_Week1': 'decimal',
                'Uren_Maandag_Week2': 'decimal',
                'Uren_Dinsdag_Week2': 'decimal',
                'Uren_Woensdag_Week2': 'decimal',
                'Uren_Donderdag_Week2': 'decimal',
                'Uren_Vrijdag_Week2': 'decimal',
            ...
            "Uren_Schemas": {
                'Uren_Maandag': 'decimal',
                'Uren_Dinsdag': 'decimal',
                'Uren_Woensdag': 'decimal',
                'Uren_Donderdag': 'decimal',
                'Uren_Vrijdag': 'decimal',
                'Uren_Zaterdag': 'decimal',
                'Uren_Zondag': 'decimal',
                'Uren_Maandag2': 'decimal',
                'Uren_Dinsdag2': 'decimal',
                'Uren_Woensdag2': 'decimal',
                'Uren_Donderdag2': 'decimal',
                'Uren_Vrijdag2': 'decimal',
                'Uren_Zaterdag2': 'decimal',
                'Uren_Zondag2': 'decimal',
                'FTE_Percentage': 'decimal',
                'Start_Datum': 'datetime',
                'WerknemerID': 'int',
            }
