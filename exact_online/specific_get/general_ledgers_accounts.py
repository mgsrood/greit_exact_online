...
if __name__ == "__main__":
    ...
    endpoint = "/bulk/Financial/GLAccounts?$select=ID,BalanceSide,BalanceType,Code,Costcenter,CostcenterDescription,Costunit,CostunitDescription,Description,Division,Type,TypeDescription"

    df = get_request(division_code, url, endpoint)
    if df is not None:
        print(df)
        export_to_csv(df, "general_ledgers_accounts.csv")
