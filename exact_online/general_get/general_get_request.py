    ...
    if response.status_code == 200:
        ...
        if new_access_token and new_refresh_token:
            ...
            if response.status_code == 200:
                ...
                print(f"Fout bij het ophalen van gegevens: {response.text}")
                return None
...
if __name__ == "__main__":
    ...
    endpoint = "/bulk/CRM/Quotations?$select=QuotationID,QuotationNumber,VersionNumber,SalesPersonFullName,Currency,Description,StatusDescription,OrderAccount,Opportunity,QuotationDate,ClosingDate,CloseDate,DeliveryDate,Remarks,YourRef,AmountDC,QuotationLines/ID,QuotationLines/AmountDC,QuotationLines/CostCenterDescription,QuotationLines/CostUnitDescription,QuotationLines/Description,QuotationLines/Discount,QuotationLines/Item,QuotationLines/LineNumber,QuotationLines/Quantity,QuotationLines/UnitDescription,QuotationLines/UnitPrice,QuotationLines/VATAmountFC,QuotationLines/VATPercentage&$expand=QuotationLines"
    ...
    if df is not None:
        ...
        print(df.head(20))
        export_to_csv(df, "test_data.csv")