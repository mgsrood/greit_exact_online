...
class DataTransformerError(RuntimeError):
    pass
...
class DataTransformer:
    ...
    def tabel_mapping_ophalen(self, tabel_id):
        ...
        df_tabel_mapping = spark.read.format("delta").load("Files/Delta/TabelMapping")
    ...
    def kolom_typing_toepassen(self, df, tabel_id):
        ...
        try:
            ...
            raise DataTransformerError(f"Fout bij het toepassen van de kolom typing: {e}")
    ...
    def kolom_mapping_toepassen(self, df, tabel_id):
        try:
            ...
            raise DataTransformerError(f"Fout bij het toepassen van de kolom mapping: {e}")
    ...
    def kolommen_toevoegen(self, df, kolom_naam, waarde):
        try:
            ...
            raise DataTransformerError(f"Fout bij het toevoegen van de kolom: {e}")
