...
def apply_column_mapping(token_struct, df, finn_it_connection_string, klantnaam, script_id, script, division_code, tabel):
    
    # Start log
    log(token_struct, finn_it_connection_string, klantnaam, f"Start data mapping", script_id, script, division_code, tabel)
    ...
    if column_mapping is None:
        ...
        log(token_struct, finn_it_connection_string, klantnaam, f"FOUTMELDING | Geen mapping gevonden", script_id, script, division_code, tabel)
        return None
    ...
    # Succes en start log
    log(token_struct, finn_it_connection_string, klantnaam, f"Data mapping succesvol", script_id, script, division_code, tabel)
